  ...
  return (
    <Pressable style={s.card} onPress={onPress}>
      ...
      <View style={s.copy}>
        ...
        <Text style={s.song}>{song}</Text>
        {progress?.personalSongSwap && (
          <Text style={s.swap}>Song swap: {progress.personalSongSwap}</Text>
        )}
...
const s = StyleSheet.create({
  ...
  song: { color: colors.muted, fontSize: 12, marginTop: 3 },
  swap: { color: colors.pink, fontSize: 12, marginTop: 5, fontWeight: "700" },
